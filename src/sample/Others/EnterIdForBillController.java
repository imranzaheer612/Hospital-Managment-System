...
public class EnterIdForBillController implements Initializable {
    ...
    private void nextScene(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("../../fxfiles/Others/getbill.fxml"));

        // passing patient id to be used in the next scene
        GetBillController controller =  new GetBillController();
