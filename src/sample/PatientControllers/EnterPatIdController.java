...
public class EnterPatIdController  implements Initializable {
    ...
    private void nextScene(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("../../fxfiles/PatientFxml/diagnosisEntry.fxml"));
        ...
        DiagnosisEntryController controller =  loader.getController();
