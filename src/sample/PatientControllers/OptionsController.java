...
public class OptionsController implements Initializable {
    ...
    private void oldPatTable(ActionEvent event) throws IOException {
        Parent roomEntryPage = FXMLLoader.load(getClass().getResource("../../fxfiles/PatientFxml/oldPatients.fxml"));
        addPatient.getScene().setRoot(roomEntryPage);
    }
    ...
    private void backToMenu(ActionEvent event) throws IOException {
        Parent startPage = FXMLLoader.load(getClass().getResource("../../fxfiles/PatientFxml/newOrEdit.fxml"));
