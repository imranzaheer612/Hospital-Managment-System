...
//        Parent root = FXMLLoader.load(getClass().getResource("../fxfiles/authenticate/authen.fxml"));
        Parent root = FXMLLoader.load(getClass().getResource("../fxfiles/Others/startupPage.fxml"));
